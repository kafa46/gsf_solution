...
from anomaly_ai.datasets.base_dataset import BaseADDataset
...
class BalancedBatchSampler(Sampler):
    def __init__(self, cfg, dataset: BaseADDataset):
        ...
        # Modified code due to UserWarning
        #   UserWarning: `data_source` argument is not used and
        #       will be removed in 2.2.0.
        #       You may still have custom implementation that utilizes it.
        #  Sampler.__init__() -> do nothing!
